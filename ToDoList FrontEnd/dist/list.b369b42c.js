...
document.querySelector('#createItemButton').addEventListener('click', function () {
  createItem();
});

function createItem() {
  var title = document.querySelector('#createItem').value;
  ...
  toDoList.save().then(function (item) {
    console.log(item);
    getAllItems();
  }, function (error) {
...
function _getAllItems() {
  _getAllItems = _asyncToGenerator(
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee() {
    var ToDoList, query, results;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ToDoList = Parse.Object.extend('ToDoList');
            query = new Parse.Query(ToDoList);
            _context.next = 4;
            return query.find();
...
function createCard(_x) {
  return _createCard.apply(this, arguments);
}

function _createCard() {
  _createCard = _asyncToGenerator(
  /*#__PURE__*/
          ...
          case 0:
            ...
            data.forEach(function (item) {
              ...
              para.addEventListener('click', function () {
                ...
                query.get(item.id).then(function (item) {
                  ...
                  while (1) {
                    switch (_context2.prev = _context2.next) {
                      ...
                      case 5:
                        ...
                        result.destroy().then(function (item) {
                          console.log(item);
                          getAllItems();
                        }, function (error) {
                          console.log(error);
...
},{}]},{},["../node_modules/parcel/src/builtins/hmr-runtime.js","js/list.js"], null)
